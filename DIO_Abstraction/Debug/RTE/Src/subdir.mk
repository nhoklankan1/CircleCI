...
RTE/Src/%.o RTE/Src/%.su RTE/Src/%.cyclo: ../RTE/Src/%.cpp RTE/Src/subdir.mk
...
clean: clean-RTE-2f-Src

clean-RTE-2f-Src:
	-$(RM) ./RTE/Src/RTE.cyclo ./RTE/Src/RTE.d ./RTE/Src/RTE.o ./RTE/Src/RTE.su

.PHONY: clean-RTE-2f-Src
